...
if ($index == 0) {
	while($is_begin || $count == $limit){
		try{
		    ...
		    $sql = "select order_id from sync_pinduoduo_order_info where order_status in (2,3) and created_time < '2021-10-01' limit {$limit}";
		     // echo date("Y-m-d H:i:s")." sql".$sql;
		    $order_list = $oms_sync_db->getCol($sql);
...
if ($index == 1) {
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	echo '[]'.'[delete_erp_sync] delete count:'.$count.' total:'.$total.' is 0 die!'.PHP_EOL;
		    	$sql = "optimize table sync_pinduoduo_order_info";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
...
if ($index == 2) {
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	echo '[]'.'[delete_erp_sync] delete count:'.$count.' total:'.$total.' is 0 die!'.PHP_EOL;
		    	$sql = "optimize table goods_pinduoduo";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
...
if ($index == 3) {
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	echo '[]'.'[delete_erp_sync] delete count:'.$count.' total:'.$total.' is 0 die!'.PHP_EOL;
		    	$sql = "optimize table sku_pinduoduo";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
	...
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	...
		    	$sql = "optimize table sync_taobao_order_info";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
	...
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	...
		    	$sql = "optimize table sync_taobao_order_goods";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
	...
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	...
		    	$sql = "optimize table sync_douyin_order_info";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
	...
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	...
		    	$sql = "optimize table sync_douyin_order_goods";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
	...
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	...
		    	$sql = "optimize table sync_kuaishou_order_info";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
	...
	while($is_begin || $count == $limit){
		try{
		    ...
		    if (empty($count)) {
		    	...
		    	$sql = "optimize table sync_kuaishou_order_goods";
            	$oms_sync_db->query($sql);
		    	die;
		    }
		    $start += $count; 
