...
require(ROOT_PATH . "includes/OSS/Core/OssUtil.php");
require(ROOT_PATH . "includes/OSS/Core/OssException.php");
require(ROOT_PATH . "includes/OSS/Http/RequestCore.php");
require(ROOT_PATH . "includes/OSS/Core/MimeTypes.php");
require(ROOT_PATH . "includes/OSS/Http/ResponseCore.php");
require(ROOT_PATH . "includes/OSS/Result/PutSetDeleteResult.php");
