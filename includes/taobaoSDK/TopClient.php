...
class TopClient
{
	...
	public $gatewayUrl = "http://erpjst.titansaas.com/taobaoapi/router/rest";
	...
	protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt)
	{
		...
		$logger->log($logData);
		// app('log')->info("top_logger: app_name:".$apiName." requestUrl:".$requestUrl." errorCode:".$errorCode." response:".$responseTxt);
	}
	...
	public function execute($request, $session = null,$bestUrl = null)
	{
		...
		if (isset($respObject->code))
		{
			...
			// 	$resp
			// ));
			// app('log')->info("top_logger: app_key:".$this->appkey." ".$respObject->code);
