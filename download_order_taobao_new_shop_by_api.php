...
global $sync_db;
$sql_get_new_taobao_shops = "SELECT se.shop_id,s.default_facility_id from shop_extension se inner join shop s on se.shop_id = s.shop_id WHERE se.platform_code = 'taobao' AND se.last_plan_sync_time < now()";
