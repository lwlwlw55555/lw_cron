...
$sql_get_all_taobao_shop = "SELECT shop_id,access_token,platform_shop_name as platform_user_name from shop WHERE platform_code = 'TAOBAO'";
$shops = $oms_sync_db->getAll($sql_get_all_taobao_shop);
